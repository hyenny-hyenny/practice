...
public class ProductDTO {
	...
	public ProductDTO(String pnum, String pname, String pcategory_fk, String pcompany, String pimage, 
						int pqty, int price, String psepec, String pcontents, int point, String pinputDate,
						int totPrice, int totPoint, int salePrice) {
		super();
		this.pnum = pnum;
		this.pname = pname;
