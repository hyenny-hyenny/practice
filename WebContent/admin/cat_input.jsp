...
<!-- 카테고리 등록 -->
	...
	<form action="prod_regOk.jsp" method="post" name="cat_inputFrm" enctype="multipart/form-data">
		<table width="500" border="1">
			...
			<tr>
				<td colspan="2" align="center"><input type="button" value="등록" onclick="inputCheck()">
